...
public class GameClientSessionManager extends AbstractGameSessionManager {
    ...
    public void onMessage(TokenInfo tokenInfo, WebsocketEnvelope<?> envelope) {
        ...
        switch (action) {
            ...
            case ReleasePlayerAction(String playerId) -> releasePlayer(partyId, playerId);
            case KickPlayerAction(String playerId, String reason) -> kickPlayer(partyId, playerId, reason);
    ...
    private void releasePlayer(String partyId, String playerId) {
        ...
        broadcastToParty(partyId, new GameClientEventEnvelope(new PlayerReleasedEvent(playerId)));
    }
    ...
    private void kickPlayer(String partyId, String playerId, String reason) {
        ...
        PlayerKickedEvent event = new PlayerKickedEvent(playerId, reason);
        broadcastToParty(partyId, new GameClientEventEnvelope(event));
