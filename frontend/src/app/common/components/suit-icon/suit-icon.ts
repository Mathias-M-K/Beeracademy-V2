...
const SUIT_PATHS: Record<Suit, readonly string[]> = {
  ...
  SQUARE: [
    'M5.8 3.4h12.4a2.4 2.4 0 0 1 2.4 2.4v12.4a2.4 2.4 0 0 1-2.4 2.4H5.8a2.4 2.4 0 0 1-2.4-2.4V5.8a2.4 2.4 0 0 1 2.4-2.4Z',
  ],
  HEXAGON: ['M12 1.8 21 7v10l-9 5.2L3 17V7Z'],
  STAR: [
    'M12 2l2.59 6.44L21.51 8.91 16.18 13.36 17.88 20.09 12 16.4 6.12 20.09 7.82 13.36 2.49 8.91 9.41 8.44Z',
  ],
