...
export class PartyApi {
  ...
  public getParty(partyId: string): Observable<PartyDto> {
    return this.httpClient
      .get<PartyDto>(`${this.apiUrl}/parties/${partyId}`)
      .pipe(map((partyStateDto) => partyStateDto));
  }

  public getCurrentParty(): Observable<CurrentPartyDto | null> {
    return this.httpClient.get<CurrentPartyDto | null>(`${this.apiUrl}/parties/current`, {
